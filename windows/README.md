...
Active configuration settings (loaded font path, font family, legacy state, toggle hotkey, and voice hotkey) are automatically saved to `%USERPROFILE%\.gemini\antigravity-cli\settings.json` and persist across application restarts.
